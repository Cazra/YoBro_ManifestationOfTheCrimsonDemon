...
public class YoBroMain extends JFrame implements WindowListener, WindowFocusListener
{
	...
	**/
	...
	public YoBroMain(boolean fullscreen)
	{
		...
		screenP = new YoBroMainPanel(this);
	...
	**/
	...
	public static void main(String[] args)
	{
		...
		if(args.length == 0)
			gui = new YoBroMain(false);
		else if(args[0].equals("fullscreen"))
			gui = new YoBroMain(true);
